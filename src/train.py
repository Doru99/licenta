...
path_to_labels = 'D:\\Repositories\\models\\research\\object_detection\\data' \
...
print('model loaded')
test_image = 'D:\\Repositories\\licenta\\image-sets\\image0.jpg'
...
print(stop_detect - start_detect)
